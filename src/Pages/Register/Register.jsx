  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-base-100 to-base-200 flex flex-col">
        ...
        <div className="card bg-base-100 w-full max-w-md shadow-2xl">
          <div className="card-body p-8">
            <form onSubmit={handleReg} className="space-y-5">
              ...
              <button type="button" className="btn btn-outline border-teal-600 btn-block gap-2">
      ...
      <footer className="py-4 text-center text-sm text-base-content/60">
        <p>By signing up, you agree to our <Link to="/terms" className="link link-hover">Terms</Link> and <Link to="/privacy" className="link link-hover">Privacy Policy</Link></p>
      </footer>
    </div>
  );
};
