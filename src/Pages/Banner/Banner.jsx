...
const Banner = () => {
  ...
  return (
    <div className="w-screen mx-auto h-[70vh] overflow-hidden rounded-2xl shadow-2xl mt-5">
  <Slider
    {...settings}
    className="h-full"
  >
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              >
                <Link
                  to={'/findtutors'}
                  className="btn px-8 py-3 bg-white text-teal-700 font-semibold rounded-full hover:bg-teal-100 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Get Started
                </Link>
              </motion.div>
