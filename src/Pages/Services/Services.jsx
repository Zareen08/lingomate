  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    >
      <div className="card-body">
        ...
        <div className="card-actions">
          <button className="btn btn-outline border-teal-600 btn-sm">Apply Now</button>
        </div>
      </div>
    </section>
    ...
    >
      <div className="card-body">
        ...
        <div className="card-actions">
          <button className="btn text-white bg-teal-600 btn-sm">View Classes</button>
        </div>
      </div>
    </section>
    ...
    >
      <div className="card-body">
        ...
        <div className="card-actions">
          <button className="btn btn-outline border-teal-600 btn-sm">Request Proposal</button>
        </div>
      </div>
    </section>
  </div>
