...
const steps = [
  {
    ...
    color: 'bg-teal-100 dark:bg-teal-800/30',
  },
  {
    ...
    <section className="py-20 bg-gradient-to-b from-base-100 to-base-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="hidden md:block absolute top-1/4 left-0 right-0 h-2 bg-teal-200/50 dark:bg-teal-800/30 z-0"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            {steps.map((step, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="h-full p-8 bg-base-100 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-base-200 group-hover:border-teal-300 flex flex-col items-center text-center">
